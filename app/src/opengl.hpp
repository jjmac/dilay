...
#include <glm/fwd.hpp>
#include <string>
#include "opengl-interface.hpp"
#include <memory>

class QOpenGLFunctions_2_1;
class QOpenGLExtension_EXT_geometry_shader4;

class OpenGL : public OpenGLInterface
{
...
private:
	QOpenGLFunctions_2_1* m_fun;
	std::unique_ptr<QOpenGLExtension_EXT_geometry_shader4> m_fun;
}
